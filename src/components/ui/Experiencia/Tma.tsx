...
import tmaLogo from './tmaLogo.png'
...
const Tma = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center text-white font-medium text-2xl gap-2 max-md:justify-center max-sm:hidden">
        <p>Tu Mejor Amigo</p>
        <MexicoIcon />
      </div>
      <div className="bg-gradient-to-r from-[#F1FF4D] to-[#3ECF8E] bg-clip-text text-transparent max-sm:hidden">
        <p className="font-medium text-2xl">Desarrollador Frontend</p>
      </div>
      <div>
        <p className="text-white font-medium text-lg max-sm:hidden">
          Noviembre 2023 - Marzo 2024
        </p>
      </div>
      <div className="bg-gradient-to-r from-[#F1FF4D] to-[#3ECF8E] p-3 rounded-xl flex flex-col justify-center items-center h-[200px] sm:hidden -translate-y-1.5">
      <div className="mb-5">
          <Image
            src={tmaLogo}
            alt="Tualo"
              ...
              <div className="flex flex-col gap-3 lg:w-[60%]">
                ...
                <div>
                  <p className="bg-gradient-to-r from-[#F1FF4D] to-[#3ECF8E] bg-clip-text text-transparent font-medium text-lg">
                    {isEnglish
                      ? "My biggest challengues"
                      : "Mis mayores desafíos"}
                  </p>
                  <ul className="list-disc flex flex-col gap-2">
                    <li>
                      {isEnglish
                        ? "Integrate an effective notification system using React Native Firebase Cloud Messaging."
                        : "Integrar un sistema de notificaciones efectivo mediante React Native Firebase Cloud Messaging."}
                    </li>
                    <li>
                      {isEnglish
                        ? "Added functionality that allowed users to upload their pet and profile pictures through Cloudinary."
                    ...
                    <li>
                      {isEnglish
                        ? "Manage the launch of the app in the Google Play Console, ensuring that the service was accessible to dog lovers looking for reliable walkers."
