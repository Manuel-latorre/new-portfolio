  ...
  return (
    <div className="flex flex-col gap-3">
        <div className="flex items-center text-white font-medium text-2xl gap-2">
          ...
          <span className="bg-gradient-to-r from-[#F1FF4D] to-[#3ECF8E] bg-clip-text text-transparent font-medium text-2xl">{isEnglish ? "Personal Project" : "Proyecto personal"}</span>
        <div>
        ...
        <div className="flex items-center text-white justify-between gap-24 max-lg:flex-col max-lg:gap-12">
          <div className="flex flex-col gap-3 lg:w-[60%]">
            <div>
              {isEnglish
                ? <p>Tech Shop API Database is a website that offers a REST API to manage technological products such as headphones, keyboards, and consoles. The API allows CRUD operations (Create, Read, Update, Delete) on three main models: <br />
                <br />
                Productos: Represents items available in the store, with properties like name, description, price, and category. <br /> <br />
                Carrito: Manages the products users add to their shopping carts, including user ID, list of products, and quantity of each product. <br /> <br />
                Usuarios: Handles user information, including properties like name, email, and password. <br /> <br />
                El backend is developed with Express and uses MongoDB for data storage. The documentation section (Docs) provides all the necessary information for consuming the API.</p>
                
                : <p>Tech Shop API Database es un sitio web que ofrece una API REST para gestionar productos tecnológicos como auriculares, teclados y consolas. La API permite realizar operaciones CRUD (Crear, Leer, Actualizar, Eliminar) sobre tres modelos principales: <br />
                <br />
                Productos: Representa los artículos disponibles en la tienda, con propiedades como nombre, descripción, precio y categoría. <br /> <br />
                Carrito: Administra los productos que los usuarios agregan a sus carritos de compras, incluyendo el ID del usuario, lista de productos y cantidad de cada producto. <br /> <br />
                Usuarios: Gestiona la información de los usuarios, con propiedades como nombre, correo electrónico y contraseña. <br /> <br />
                El backend está desarrollado con Express y utiliza MongoDB para el almacenamiento de datos. La sección de documentación (Docs) proporciona toda la información necesaria para consumir la API.</p>}
            </div>
