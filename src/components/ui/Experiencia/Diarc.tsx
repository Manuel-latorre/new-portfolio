...
import diarcLogo from './logo-diarc1.png'
...
const Diarc = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <Link
        href={"https://www.diarc.studio/"}
        className="p-2 rounded-xl bg-transparent border-2 border-[#F1FF4D] flex items-center gap-2 text-white font-semibold w-[100px] max-sm:hidden"
      >
        <WebIcon />
      ...
      <div className="bg-gradient-to-r from-[#F1FF4D] to-[#3ECF8E] p-3 rounded-xl flex flex-col justify-center items-center h-[200px] sm:hidden">
          <div className="mb-5">
            <Image src={diarcLogo} alt="Diarc" width={100} height={100} className="invert"/>
          </div>
        <Modal
          title="Diarc Studio"
          icon={<ArgentinaIcon />}
