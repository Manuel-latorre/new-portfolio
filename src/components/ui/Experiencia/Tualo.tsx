"use client";import Carrusel from "@/components/Carrusel";
...
import logoTualo from "./tualo-logo.png";
...
const Tualo = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <Link
        href={"https://www.tualo.mx/"}
        className="p-2 rounded-xl bg-transparent border-2 border-[#F1FF4D] max-md:mx-auto flex items-center gap-2 text-white font-semibold w-[100px] max-sm:hidden"
      >
        <WebIcon />
